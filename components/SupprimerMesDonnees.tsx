...
const RISK_SELECTION_KEY = "risk_analysis_selection";
            ...
            <span className="text-xs font-medium text-gray-600 bg-gray-100 px-2.5 py-1 rounded-full">
              {service.nationality || "International"}
                ...
                {step === 2 && currentService && (
                    <div className="space-y-6">
                        {/* Progress - Hidden in single service mode */}
                        {!isSingleServiceMode && (
                            <div className="card bg-base-100 shadow-xl">
                                <div className="card-body">
                        ...
                        <div ref={serviceCardRef} className="card bg-base-100 shadow-xl">
                            <div className="card-body">
                                ...
                                <div className="flex justify-center gap-4 flex-wrap">
                                    {/* Previous button - Hidden in single service mode */}
                                    {!isSingleServiceMode && (
                                        <button
                                ...
                                {/* Service counter - Hidden in single service mode */}
                                {!isSingleServiceMode && (
                        ...
                        {/* Quick navigation - Hidden in single service mode */}
                        {!isSingleServiceMode && (
