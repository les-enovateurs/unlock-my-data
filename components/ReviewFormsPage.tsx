                        ...
                        <div className="umd-acc-body">
                          {category.fields.map(field => {
                            ...
                            const nationalitySummary = field === "nationality"
                              ...
                              : undefined;
                            // Read the thread from the card itself, not from the
                            // reviews.json index: the index is only regenerated by
                            // the data scripts, so after a review PR merges it
                            // still shows closed comments as open.
                            const fieldCommentEntries = buildFieldCommentEntries({
                              review: fullServiceData[service.slug]?.review || service.review || [],
                              field,
                              slug: service.slug,
                              replies,
                              resolvedComments
