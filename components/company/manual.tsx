        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-5">
                ...
                <div>
                    ...
                    {/* --- Unified Data Breaches Section (HIBP + Bonjour la Fuite) --- */}
                    {(hasBreachData || (lang === 'fr' && entreprise.data_breaches && entreprise.data_breaches.length > 0)) && (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow mt-6">
                            {/* Header */}
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-3">
                                            {sortedBreaches.map((breach, idx) => (
                                                <div key={`hibp-${idx}`} className="bg-red-50 rounded-lg border border-red-100 p-4 hover:border-red-200 transition-colors">
