...
export default function Footer() {
    ...
    const navigationLinks = [
        ...
        {
            label: isFr ? "Liste des applications" : "Applications list",
            href: isFr ? "/liste-applications" : "/list-app",
        },
        {
            label: isFr ? "Comparer" : "Compare",
    ...
    const toolsLinks = [
        {
            label: isFr ? "Protéger mes données" : "Protect my data",
            href: isFr ? "/proteger-mes-donnees" : "/protect-my-data",
        },
        {
            label: isFr ? "Supprimer mes données" : "Delete my data",
        ...
        },
        {
            ...
            href: isFr ? "/evaluer-mes-risques" : "/evaluate-my-risks",
        },
    ];
    ...
    const legalLinks = [
        ...
        },
        {
            ...
            href: isFr ? "/politique-confidentialite" : "/privacy-policy",
        },
    ];
