        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mb-6">
                    Search and compare up to 3 services to analyze their permissions, trackers and privacy points
                </p>
                ...
                <div className="inline-flex items-center justify-center bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 text-sm text-amber-800 max-w-2xl mx-auto">
                    ...
                    <p>
                        ...
                        If you notice any errors, feel free to{" "}
                        <Link href="/contribute" className="underline font-semibold hover:text-amber-900">
                            suggest corrections
                        </Link>.
                    </p>
                </div>
            ...
            {selectedServices.length > 0 && (
                <div ref={comparisonRef} className="mb-8">
                    <div
                        ...
                        <h2 className="text-xl font-semibold mb-4">Selected services
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-blue-100">
                                        ...
                                        <div className="text-sm text-gray-600 mb-4 space-y-2 w-full text-left">
                                            <div className="flex items-start">
                                                ...
                                                <p className="text-xs leading-tight">
                                                    <span className="font-semibold">{dCount === null ? "Unknown data" : `${dCount} sensitive permissions`}</span>
                                                    {dCount !== null && dCount > 0 && <span className="block text-gray-500 text-[10px]">Microphone, camera, contacts access...</span>}
                                                </p>
                                            </div>
                                            <div className="flex items-start">
                                                ...
                                                <p className="text-xs leading-tight">
                                                    <span className="font-semibold">{tCount === null ? "Unknown data" : `${tCount} advertising trackers`}</span>
                                                    {tCount !== null && tCount > 0 && <span className="block text-gray-500 text-[10px]">Tracking your activity</span>}
                                                </p>
                                            </div>
                                            <div className="flex items-start">
                                                ...
                                                <p className="text-xs leading-tight">
                                                    <span className="font-semibold">{bCount === null || service.tosdr === "" ? "Unknown data" : `${bCount} legal issues`}</span>
                                                    {bCount !== null && bCount > 0 && <span className="block text-gray-500 text-[10px]">Abusive terms of service</span>}
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div className="mt-6 bg-blue-50 p-4 rounded-lg flex items-start">
                            ...
                            <div>
                                <h4 className="font-semibold text-blue-900 text-sm mb-1">Why delete your data?</h4>
                                <p className="text-sm text-blue-800">
                                    If a service collects too much information or poses risks to your privacy,
                                    the best way to protect yourself is often to delete your account and data.
                            ...
                            <table className="w-full border-collapse bg-white text-sm">
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="p-4 text-gray-600 font-medium">
                                        Data access ease
                                        <p className="text-xs text-gray-400 font-normal mt-0.5">Rating out of 5 for ease of retrieving your info</p>
                                    </td>
                                    {selectedServices.map((service) => {
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="p-4 text-gray-600 font-medium">
                                        ...
                                        <p className="text-xs text-gray-400 font-normal mt-0.5">Do you need to send your ID card?</p>
                                    </td>
                                    {selectedServices.map((service) => {
                                        const manualData = manualDataCache[service.slug];
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="p-4 text-gray-600 font-medium">
                                        Storage outside EU
                                        <p className="text-xs text-gray-400 font-normal mt-0.5">Does your data leave Europe?</p>
                                    </td>
                                    {selectedServices.map((service) => {
                                        const manualData = manualDataCache[service.slug];
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    ...
                                    {selectedServices.map((service) => {
                                        const manualData = manualDataCache[service.slug];
                                        const transferCountries = manualData?.transfer_destination_countries_en;
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="p-4 text-gray-600 font-medium">
                                        Previously sanctioned (CNIL/GDPR)
                                        <p className="text-xs text-gray-400 font-normal mt-0.5">Has the company been fined before?</p>
                                    </td>
                                    {selectedServices.map((service) => {
                                        const manualData = manualDataCache[service.slug];
                                ...
                                <table className="w-full border-collapse bg-white text-sm">
                                    ...
                                    <tr>
                                        <th className="p-4 text-left font-semibold text-gray-900 border-b border-gray-200 w-1/3">
                                            ...
                                            <p className="text-xs text-gray-500 font-normal mt-1">Access to critical features of your phone</p>
                                        </th>
                                        {selectedServices.map((service) => (
                                            <th key={service.slug}
                                                    ...
                                                    <td key={service.slug}
                                                        ...
                                                        {permissions[service.slug]?.permissions.includes(permission.name) ? (
                                                            <div className="flex flex-col items-center">
                                                                ...
                                                                <span className="text-xs font-bold text-red-600">ACCESS</span>
                                                            </div>
                                                        ) : (
                                                            <div className="flex flex-col items-center">
                                ...
                                <table className="w-full border-collapse bg-white text-sm">
                                    ...
                                    <tr>
                                        <th className="p-4 text-left font-semibold text-gray-900 border-b border-gray-200 w-1/3">
                                            ...
                                            <p className="text-xs text-gray-500 font-normal mt-1">Advertising and analytics trackers</p>
                                        </th>
                                        {selectedServices.map((service) => (
                                            <th key={service.slug}
                                                className="p-4 text-center border-b border-gray-200 min-w-[140px]">
                    ...
                    {Object.keys(servicesData).length > 0 && (
                        <section id={"negative-points"} className="p-4">
                            <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
                                <table className="w-full border-collapse bg-white text-sm">
                                    <thead className="bg-gray-50">
                                    <tr>
                                        <th className="p-4 text-left font-semibold text-gray-900 border-b border-gray-200 w-1/3">
                                            <div className="flex items-center">
                                                ...
                                                Warning Points (ToS;DR)
                                            </div>
                                            <p className="text-xs text-gray-500 font-normal mt-1">Issues in terms of service</p>
                                        </th>
                                        {selectedServices.map((service) => (
                                            <th key={service.slug}
                                                className="p-4 text-center border-b border-gray-200 min-w-[140px]">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white shadow-lg mt-12">
                <h2 className="text-2xl font-bold mb-4">Want to take back control?</h2>
                <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
                    If these results concern you, know that you have the right to request the deletion of your personal data. We have created a tool to help you with this process.
                </p>
                <Link
                    href="/delete-my-data"
