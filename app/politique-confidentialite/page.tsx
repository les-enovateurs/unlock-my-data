            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <section className="mb-12">
                        ...
                        <p className="mb-4">Nous collectons uniquement les données nécessaires au bon fonctionnement de
                            notre service :</p>
                    ...
                    <section className="mb-12">
                        ...
                        <p className="mb-4">Aucune donnée personnelle n'étant traitée, les droits prévus par le RGPD
                            (accès, rectification, effacement, limitation, portabilité, opposition) ne sont pas
                            applicables.</p>
                    </section>
                    ...
                    <section className="mb-12">
                        ...
                        <p className="mb-4">
                            ...
                            <a href="mailto:contact@les-enovateurs.com"
