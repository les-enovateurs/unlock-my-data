    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Celebrating our amazing contributors</p>
          <div className="mt-4 flex items-center justify-center gap-4 text-sm text-gray-500">
            <span className="flex items-center gap-2">
              <FaUsers />
              {stats.totalFiles} Companies
            </span>
            <span className="flex items-center gap-2">
              <FaCalendar />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
            ...
            <div className="text-gray-600 mt-2">Total Companies</div>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center transform hover:scale-105 transition-transform">
            ...
            <div className="text-gray-600 mt-2">Updaters</div>
          </div>
        </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{creator.count} companies created</div>
                    </div>
                  </div>
                ...
                {selectedCreator?.name === creator.name && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="text-sm font-semibold text-gray-700 mb-2">Companies:</div>
            ...
            {stats.topUpdaters.map((updater, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{updater.count} updates</div>
                    </div>
                  </div>
                ...
                {selectedUpdater?.name === updater.name && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="text-sm font-semibold text-gray-700 mb-2">Updated companies:</div>
                    <div className="max-h-40 overflow-y-auto space-y-1">
        ...
        <div className="mt-16 text-center text-gray-500 text-sm">
          <p>Thank you to all contributors for making Unlock My Data better! 🙏</p>
            <p className="mt-2">To contribute more, you can <Link href={"/contribute"} className={"bg-green-700 text-white hover:text-black hover:border hover:border-green-700 p-2 rounded-3xl hover:bg-white"} prefetch={false}>read everything needed</Link></p>
        </div>
      </div>
    </div>
  );
